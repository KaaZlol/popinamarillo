...
package net.mcreator.lucipere.world.structure;
...
public class StructureHouseAbuelita extends ElementsLucipere.ModElement {
	public StructureHouseAbuelita(ElementsLucipere instance) {
		super(instance, 5);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 10000) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("lucipere", "abuelitauwu"));
				if (template == null)
					return;
